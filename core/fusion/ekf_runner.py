...
from core.fusion.ekf_core import (
...
from core.geo.geodesy import normalize_gps_measurement
...
def run_ekf_on_log(data: Dict[str, List[dict]]) -> Optional[Dict[str, List[float]]]:
    """Run EKF fusion over ArduPilot telemetry and return NED trajectory."""
    events = []
